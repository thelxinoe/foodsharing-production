...
const AppHeader = React.createClass({
    ...
    //
    //     return {
    //         foodItems: FoodItemsC.find({
    //             '$and': [filterQuery, listMessageQuery]
    //         }, {
    //             sort: {
    //                 createdAt: -1
    //             }
    ...
    render: function() {
        ...
        //pull this out
        const actions = [ < FlatButton label = "Logout" primary = {
                true
            }
            onTouchTap = {
                this.handleLogout
            } />, < FlatButton label = "Change Password" primary = {
                true
            }
            onTouchTap = {
                ...
                <div className="phone">
                  <div className="container">
                            ...
                            <div className="headContain">
                                <AppBar title="" iconElementLeft={< IconButton onTouchTap = {
                                    this.handleBackClick
                                } > <SvgIcons.ContentReply color={green900}/> < /IconButton>} iconElementRight={< IconButton containerElement = { < Link to = {
                                        '/ItemCreation'
                                    } />
                                } > <SvgIcons.ContentAddCircle color={green900}/> < /IconButton>} targetOrigin={{
                                    horizontal: 'right',
                                    vertical: 'top'
                                }}/>
                            </div>

                            //pull the tool bar out
                            <div className="toolContain">
                                <Toolbar>
                                    <ToolbarGroup firstChild={true}>
                                        {Meteor.userId()
                                            ? <div>
                                                    ...
                                                    <Dialog title="Logout" actions={actions} modal={true} contentStyle={logoutContentStyle} open={this.state.openLogout}>
                                            ...
                                            : <div>
                                                <IconButton containerElement={< Link to = {
                                                    '/login'
                                                } />} tooltip="Account" tooltipPosition="bottom-right">
                                                    <SvgIcons.ActionAccountCircle color='White'/>
                                                </IconButton>
                                            </div>
}
                                    ...
                                    <ToolbarGroup lastChild={true}>
                                        <IconButton onTouchTap={this.handleOpenNav} tooltip="Messages" tooltipPosition="bottom-left" disabled={this.data.currentUser
                                            ? false
                                            : true}>
                            ...
                            // Pull all the tabs out
                            <div className="tabsContain">

                                <Tabs>
                                    <Tab icon={< ActionDashboard color = {
                                        green900
                                    } />} label="ITEM VIEW" onActive={this.handleActiveTab("/")} style={tabStyle}/>
                                    <Tab icon={< MapsMap color = {
                                        green900
                                    } />} label="MAP VIEW" onActive={this.handleActiveTab("/MapView")} style={tabStyle}/>
                                    <Tab icon={< MapsPersonPin color = {
                                        green900
                                    } />} label="YOUR ITEMS" onActive={this.handleActiveTab("/YourItems")} style={tabStyle}/>
                                </Tabs>
                            ...
                            <div>
                                <Snackbar open={this.state.openLogMess} message="You've been logged out!" autoHideDuration={3600} onRequestClose={this.handleRequestClose} action="Close" onTouchTap={this.handleRequestClose}/>
                            </div>
