...
const YourItems = React.createClass({
  ...
  genPrtnImg: function (item) {
    ...
    generateItems: function () {
      ...
      if(this.props.foodItemList!==[]){
        return this.props.foodItemList.map((item) => {
          var foodTit = item.foodName
          return (
            <div>
